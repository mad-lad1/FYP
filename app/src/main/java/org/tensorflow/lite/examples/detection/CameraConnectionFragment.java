...
public class CameraConnectionFragment extends Fragment {
  ...
  private CameraConnectionFragment(
      ...
      final int layout,
      final Size inputSize, Context context) {
  ...
  public View onCreateView(
    ...
    try {
      imageSegmenter = new ImageSegmenter((Activity) context);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void onViewCreated(final View view, final Bundle savedInstanceState) {
    ...
    segmenterOverlay = (ImageView) view.findViewById(R.id.segmenterOverlay);
  }
